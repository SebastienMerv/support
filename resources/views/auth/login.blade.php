...
<body>
    <div class="container bg-slate-100 h-screen flex items-center flex-col">
        ...
        <div class="bg-white w-80 flex flex-col items-center p-12 w-[800px] h-[400px]">
            ...
            <div class="flex flex-col w-96 m-8">
                ...
                <input id="email" type="text" placeholder="Votre adresse email de connexion" class="p-2 border border-gray-400 rounded-lg h-12">
            </div>

            <div class="flex flex-col w-96">
                <label for="password">Mot de passe</label>
                <input type="text" placeholder="Votre mot de passe"class="p-2 border border-gray-400 rounded-lg h-12">
            </div>
