...
<body>
    <form class="w-screen bg-slate-100 h-screen flex items-center flex-col" method="POST" action="{{ route('process.token', ['token' => $token]) }}">
        @csrf
        ...
        <div class="bg-white w-80 flex flex-col items-center p-12 w-[800px] h-[400px]">
            ...
            <div class="flex flex-col w-96 m-8">
                ...
                <input id="password" name="password" type="password" placeholder="Votre mot de passe" class="p-2 border border-gray-400 rounded-lg h-12">
            </div>
