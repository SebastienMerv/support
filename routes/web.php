...
Route::get('/', 'App\Http\Controllers\TicketController@dashboard');

// Group of Tickets
Route::group(['prefix' => 'tickets'], function() {
    Route::get('/', 'App\Http\Controllers\TicketController@index');
    Route::get('/create', 'App\Http\Controllers\TicketController@create');
    Route::post('/store', 'App\Http\Controllers\TicketController@store');
